...
3. Right-click on the file "game.html" in the file explorer.
...
4. PLAYING:
   - Open your web browser to: http://localhost:3000/menu.html
...
The site root (`index.html`) redirects automatically to `menu.html`.
...
/scripts -> Node.js tooling: map_server.js (dev save/load server) and build-static.mjs (Cloudflare build).

...
const BEETLE_SPEED_CLOSE      = 0.04;  // chase speed (tiles/frame) when near player
const BEETLE_SPEED_FAR        = 0.03;  // chase speed (tiles/frame) when farther away; also lunge speed

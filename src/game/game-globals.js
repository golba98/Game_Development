...
let ghostMoveSprite = null;
let ghostAttackSprite = null;
...
let playerHealthRegenAccumulator = 0;
const PLAYER_HEALTH_REGEN_DELAY_MS = 6000;
const PLAYER_HEALTH_REGEN_INTERVAL_MS = 4000;
...
// Disabled `willReadFrequently` patch to unlock native GPU hardware acceleration for the game loop.
...
const GameGroups = {
  ...
  Core: {
    ...
    createMapImage: (...a) =>
      typeof createMapImage === "function" ? createMapImage(...a) : undefined,
    createFullWindowCanvas: (...a) =>
      typeof createFullWindowCanvas === "function"
        ? createFullWindowCanvas(...a)
        : undefined,
    enforceCanvasSharpness: (...a) =>
      typeof enforceCanvasSharpness === "function"
        ? enforceCanvasSharpness(...a)
        : undefined,
    injectCustomStyles: (...a) =>
      typeof injectCustomStyles === "function"
        ? injectCustomStyles(...a)
        : undefined,
    updateBackgroundVideo: (...a) =>
      typeof updateBackgroundVideo === "function"
        ? updateBackgroundVideo(...a)
        : undefined,
    ensureLoopFallbackBuffer: (...a) =>
      typeof ensureLoopFallbackBuffer === "function"
        ? ensureLoopFallbackBuffer(...a)
        : undefined,
    captureLoopFallbackFrame: (...a) =>
      typeof captureLoopFallbackFrame === "function"
        ? captureLoopFallbackFrame(...a)
        : undefined,
  },
  ...
  Map: {
    generateMap: (...a) =>
      typeof generateMap === "function" ? generateMap(...a) : undefined,
    generateMap_Part1: (...a) =>
      typeof generateMap_Part1 === "function"
        ? generateMap_Part1(...a)
        : undefined,
    generateMap_Part2: (...a) =>
      typeof generateMap_Part2 === "function"
        ? generateMap_Part2(...a)
        : undefined,
    computeClearArea: (...a) =>
      typeof computeClearArea === "function"
        ? computeClearArea(...a)
        : undefined,
    applyNoiseTerrain: (...a) =>
      typeof applyNoiseTerrain === "function"
        ? applyNoiseTerrain(...a)
        : undefined,
    postProcessRiversAndClearArea: (...a) =>
      typeof postProcessRiversAndClearArea === "function"
        ? postProcessRiversAndClearArea(...a)
        : undefined,
    generateHills: (...a) =>
      typeof generateHills === "function" ? generateHills(...a) : undefined,
    getHillTileType: (...a) =>
      typeof getHillTileType === "function" ? getHillTileType(...a) : undefined,
    pruneUnreachable: (...a) =>
      typeof pruneUnreachable === "function"
        ? pruneUnreachable(...a)
        : undefined,
  },
  ...
  Rivers: {
    carveRivers: (...a) =>
      typeof carveRivers === "function" ? carveRivers(...a) : undefined,
    carveRiversMaybeThrough: (...a) =>
      typeof carveRiversMaybeThrough === "function"
        ? carveRiversMaybeThrough(...a)
        : undefined,
    carveBranchFromRiver: (...a) =>
      typeof carveBranchFromRiver === "function"
        ? carveBranchFromRiver(...a)
        : undefined,
    layBridgeTile: (...a) =>
      typeof layBridgeTile === "function" ? layBridgeTile(...a) : undefined,
    smoothRiverTiles: (...a) =>
      typeof smoothRiverTiles === "function"
        ? smoothRiverTiles(...a)
        : undefined,
    roundRiverTips: (...a) =>
      typeof roundRiverTips === "function" ? roundRiverTips(...a) : undefined,
    ensureInteractiveClearArea: (...a) =>
      typeof ensureInteractiveClearArea === "function"
        ? ensureInteractiveClearArea(...a)
        : undefined,
    ensureEdgeLayerConnectivity: (...a) =>
      typeof ensureEdgeLayerConnectivity === "function"
        ? ensureEdgeLayerConnectivity(...a)
        : undefined,
  },
  ...
  Movement: {
    handleMovement: (...a) =>
      typeof handleMovement === "function" ? handleMovement(...a) : undefined,
    tryMoveDirection: (...a) =>
      typeof tryMoveDirection === "function"
        ? tryMoveDirection(...a)
        : undefined,
    handleItemInteraction: (...a) =>
      typeof handleItemInteraction === "function"
        ? handleItemInteraction(...a)
        : undefined,
    canMoveTo: (...a) =>
      typeof canMoveTo === "function" ? canMoveTo(...a) : undefined,
    isSolid: (...a) =>
      typeof isSolid === "function" ? isSolid(...a) : undefined,
    startMoveVisual: (...a) =>
      typeof startMoveVisual === "function" ? startMoveVisual(...a) : undefined,
    updateMovementInterpolation: (...a) =>
      typeof updateMovementInterpolation === "function"
        ? updateMovementInterpolation(...a)
        : undefined,
    updateSprintState: (...a) =>
      typeof updateSprintState === "function"
        ? updateSprintState(...a)
        : undefined,
    getActiveMoveDurationMs: (...a) =>
      typeof getActiveMoveDurationMs === "function"
        ? getActiveMoveDurationMs(...a)
        : undefined,
    getActiveMoveCooldownMs: (...a) =>
      typeof getActiveMoveCooldownMs === "function"
        ? getActiveMoveCooldownMs(...a)
        : undefined,
    getCellSizeSpeedScale: (...a) =>
      typeof getCellSizeSpeedScale === "function"
        ? getCellSizeSpeedScale(...a)
        : undefined,
    drawPlayer: (...a) =>
      typeof drawPlayer === "function" ? drawPlayer(...a) : undefined,
    deltaToDirection: (...a) =>
      typeof deltaToDirection === "function"
        ? deltaToDirection(...a)
        : undefined,
    directionToDelta: (...a) =>
      typeof directionToDelta === "function"
        ? directionToDelta(...a)
        : undefined,
    findFloodStart: (...a) =>
      typeof findFloodStart === "function" ? findFloodStart(...a) : undefined,
    neighbors: (...a) =>
      typeof neighbors === "function" ? neighbors(...a) : undefined,
    getTileState: (...a) =>
      typeof getTileState === "function" ? getTileState(...a) : undefined,
  },
  // Save/load: map serialization, server fetch, localStorage settings persistence.
  IO: {
    buildActiveMapPayload: (...a) =>
      typeof buildActiveMapPayload === "function"
        ? buildActiveMapPayload(...a)
        : undefined,
    saveMap: (...a) =>
      typeof saveMap === "function" ? saveMap(...a) : undefined,
    downloadMapJSON: (...a) =>
      typeof downloadMapJSON === "function" ? downloadMapJSON(...a) : undefined,
    autosaveMap: (...a) =>
      typeof autosaveMap === "function" ? autosaveMap(...a) : undefined,
    persistActiveMapToServer: (...a) =>
      typeof persistActiveMapToServer === "function"
        ? persistActiveMapToServer(...a)
        : undefined,
    tryFetchActiveMap: (...a) =>
      typeof tryFetchActiveMap === "function"
        ? tryFetchActiveMap(...a)
        : undefined,
    applyLoadedMap: (...a) =>
      typeof applyLoadedMap === "function" ? applyLoadedMap(...a) : undefined,
    loadMapFromStorage: (...a) =>
      typeof loadMapFromStorage === "function"
        ? loadMapFromStorage(...a)
        : undefined,
    showFilePickerToLoadActiveMap: (...a) =>
      typeof showFilePickerToLoadActiveMap === "function"
        ? showFilePickerToLoadActiveMap(...a)
        : undefined,
    persistSavedSettings: (...a) =>
      typeof persistSavedSettings === "function"
        ? persistSavedSettings(...a)
        : undefined,
    saveLocalSettings: (...a) =>
      typeof saveLocalSettings === "function"
        ? saveLocalSettings(...a)
        : undefined,
    saveLocalSettingsDebounced: (...a) =>
      typeof saveLocalSettingsDebounced === "function"
        ? saveLocalSettingsDebounced(...a)
        : undefined,
    loadLocalSettings: (...a) =>
      typeof loadLocalSettings === "function"
        ? loadLocalSettings(...a)
        : undefined,
  },
  ...
  Assets: {
    trackLoadImage: (...a) =>
      typeof trackLoadImage === "function" ? trackLoadImage(...a) : undefined,
    trackLoadSound: (...a) =>
      typeof trackLoadSound === "function" ? trackLoadSound(...a) : undefined,
    AssetTracker: () => AssetTracker,
    cleanImageBrown: (...a) =>
      typeof cleanImageBrown === "function" ? cleanImageBrown(...a) : undefined,
    backupCustomAssets: (...a) =>
      typeof backupCustomAssets === "function"
        ? backupCustomAssets(...a)
        : undefined,
    removeCustomAssetsRuntime: (...a) =>
      typeof removeCustomAssetsRuntime === "function"
        ? removeCustomAssetsRuntime(...a)
        : undefined,
    restoreCustomAssetsRuntime: (...a) =>
      typeof restoreCustomAssetsRuntime === "function"
        ? restoreCustomAssetsRuntime(...a)
        : undefined,
    toggleCustomAssetsRuntime: (...a) =>
      typeof toggleCustomAssetsRuntime === "function"
        ? toggleCustomAssetsRuntime(...a)
        : undefined,
  },
  ...
  Audio: {
    applyVolumes: (...a) =>
      typeof applyVolumes === "function" ? applyVolumes(...a) : undefined,
    attemptStartGameMusic: (...a) =>
      typeof attemptStartGameMusic === "function"
        ? attemptStartGameMusic(...a)
        : undefined,
    unlockAudioAndStart: (...a) =>
      typeof unlockAudioAndStart === "function"
        ? unlockAudioAndStart(...a)
        : undefined,
    startMenuMusicIfNeeded: (...a) =>
      typeof startMenuMusicIfNeeded === "function"
        ? startMenuMusicIfNeeded(...a)
        : undefined,
    playClickSFX: (...a) =>
      typeof playClickSFX === "function" ? playClickSFX(...a) : undefined,
    normalizeDifficultyValue: (...a) =>
      typeof normalizeDifficultyValue === "function"
        ? normalizeDifficultyValue(...a)
        : undefined,
    setDifficulty: (...a) =>
      typeof setDifficulty === "function" ? setDifficulty(...a) : undefined,
    getDifficultyDisplayLabel: (...a) =>
      typeof getDifficultyDisplayLabel === "function"
        ? getDifficultyDisplayLabel(...a)
        : undefined,
  },
  ...
  Clouds: {
    spawnCloud: (...a) =>
      typeof spawnCloud === "function" ? spawnCloud(...a) : undefined,
    updateClouds: (...a) =>
      typeof updateClouds === "function" ? updateClouds(...a) : undefined,
    drawClouds: (...a) =>
      typeof drawClouds === "function" ? drawClouds(...a) : undefined,
    RandomEnvironment: (...a) =>
      typeof RandomEnvironment === "function"
        ? RandomEnvironment(...a)
        : undefined,
    applyEnvironmentDefaults: (...a) =>
      typeof applyEnvironmentDefaults === "function"
        ? applyEnvironmentDefaults(...a)
        : undefined,
  },
  ...
  Utils: {
    showToast: (...a) =>
      typeof showToast === "function" ? showToast(...a) : undefined,
    updateLoadingOverlayDom: (...a) =>
      typeof updateLoadingOverlayDom === "function"
        ? updateLoadingOverlayDom(...a)
        : undefined,
    ensureLoadingOverlayDom: (...a) =>
      typeof ensureLoadingOverlayDom === "function"
        ? ensureLoadingOverlayDom(...a)
        : undefined,
    getColorForState: (...a) =>
      typeof getColorForState === "function"
        ? getColorForState(...a)
        : undefined,
    floodReachable: (...a) =>
      typeof floodReachable === "function" ? floodReachable(...a) : undefined,
  },
  // Input: mouse/keyboard events, resize confirmation, pause toggle.
  Input: {
    mousePressed: (...a) =>
      typeof mousePressed === "function" ? mousePressed(...a) : undefined,
    keyPressed: (...a) =>
      typeof keyPressed === "function" ? keyPressed(...a) : undefined,
    windowResized: (...a) =>
      typeof windowResized === "function" ? windowResized(...a) : undefined,
    _confirmResize: (...a) =>
      typeof _confirmResize === "function" ? _confirmResize(...a) : undefined,
    togglePauseMenuFromEscape: (...a) =>
      typeof togglePauseMenuFromEscape === "function"
        ? togglePauseMenuFromEscape(...a)
        : undefined,
    attemptStartGameMusic: (...a) =>
      typeof attemptStartGameMusic === "function"
...
function updateLoadingProgressTick() {
  ...
  overlayProgress = Math.min(
    100,
    overlayProgress + (delta / 1000) * LOADING_PROGRESS_RATE,
  );
}
...
try {
  if (localStorageAvailable) {
    ...
    if (!persistentGameId) {
      ...
      try {
        window.localStorage.setItem("persistentGameId", persistentGameId);
      } catch (e) {
        localStorageAvailable = false;
      }
    }
...
try {
  window.setEdgeLayerColor = setEdgeLayerColor;
} catch (e) {}
...
function removeCustomAssetsRuntime() {
  try {
    ...
    try {
      TILE_IMAGES[TILE_TYPES.RIVER] = null;
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.RAMP] = null;
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.LOG] = null;
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.GRASS] = null;
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.FOREST] = null;
    } catch (e) {}
    CUSTOM_ASSETS_OFF = true;
    verboseLog("[game] custom assets removed (runtime)");
  } catch (e) {
    console.warn("[game] removeCustomAssetsRuntime failed", e);
  }
}
...
function restoreCustomAssetsRuntime() {
  try {
    ...
    TILE_IMAGES["gentle_forest"] =
      __ASSET_BACKUP.gentle_forest || TILE_IMAGES["gentle_forest"];
    TILE_IMAGES["gentle_trees"] =
      __ASSET_BACKUP.gentle_trees || TILE_IMAGES["gentle_trees"];
    TILE_IMAGES["water_1"] = __ASSET_BACKUP.water_1 || TILE_IMAGES["water_1"];
    TILE_IMAGES["bridge_1"] =
      __ASSET_BACKUP.bridge_1 || TILE_IMAGES["bridge_1"];
    TREE_OVERLAY_IMG = __ASSET_BACKUP.tree_overlay || TREE_OVERLAY_IMG;
    try {
      TILE_IMAGES[TILE_TYPES.RIVER] =
        __ASSET_BACKUP.river_alias || TILE_IMAGES[TILE_TYPES.RIVER];
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.RAMP] =
        __ASSET_BACKUP.ramp_alias || TILE_IMAGES[TILE_TYPES.RAMP];
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.LOG] =
        __ASSET_BACKUP.log_alias || TILE_IMAGES[TILE_TYPES.LOG];
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.GRASS] =
        __ASSET_BACKUP.grass_alias || TILE_IMAGES[TILE_TYPES.GRASS];
    } catch (e) {}
    try {
      TILE_IMAGES[TILE_TYPES.FOREST] =
        __ASSET_BACKUP.forest_alias || TILE_IMAGES[TILE_TYPES.FOREST];
    } catch (e) {}
    CUSTOM_ASSETS_OFF = false;
    verboseLog("[game] custom assets restored (runtime)");
  } catch (e) {
    console.warn("[game] restoreCustomAssetsRuntime failed", e);
  }
}
...
const RIVER_CLEAR_MODES = Object.freeze({
  ALWAYS: "always",
  NEVER: "never",
  AUTO: "auto",
});
...
const DIFFICULTY_SETTINGS = {
  ...
  hard: { mobChance: 0.1, maxMobs: 300, rampRatio: 0.2 },
};
